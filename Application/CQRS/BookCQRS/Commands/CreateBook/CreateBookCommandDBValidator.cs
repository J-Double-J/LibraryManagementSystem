...
{
    public class CreateBookCommandDBValidator : LibraryValidator<CreateBookCommand>
    {
        private readonly IBookRepository _bookRepository;
        private readonly ILibraryManagementConfiguration _configuration;
        
        public CreateBookCommandDBValidator(IBookRepository bookRepository, ILibraryManagementConfiguration configuration)
            : base(LibraryValidatorType.Database, true)
        {
